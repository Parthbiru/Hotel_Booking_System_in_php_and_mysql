...
<div class="row">
  ...
  <h5> Send a Message</h5>
   <div class="mb-3">
            ...
            <input name="name"required type="text" class="form-control" id="name" placeholder="Enter your name" required>
          </div>
          <div class="mb-3">
            <label  class="form-label" style="font-weight:500;">Email</label>
            <input   name="email" required type="text" class="form-control" id="email" placeholder="Enter your Email ID" required>
          </div>
          <div class="mb-3">
            <label  class="form-label "style="font-weight:500;">Number</label>
            <input  name="Number"required  type="Number" class="form-control" id="number" placeholder="Enter your number" required>
          </div>
          <div class="mb-3">
            <label class="form-label"style="font-weight:500;">Message</label>
            <textarea name="message" required class="form-control shadow-none" rows="1" id="message"style="resize:none;" placeholder="Enter your Inquiry/Message"></textarea>
          </div>
...
document.getElementById("login-form").addEventListener("submit", function(event) {
    ...
    if (message.length < 5) {
        alert("Please enter a valid message (at least 5 characters).");
        event.preventDefault();
        return;
    }
});
